-- Create temporary table for new courses
...
-- Insert new courses into temporary table
INSERT INTO temp_courses (title, description, price, image_url)
VALUES
  (
...
-- Safely update courses table
BEGIN;
  -- Delete existing courses
  DELETE FROM courses;
  
  -- Insert new courses from temporary table
  INSERT INTO courses (title, description, price, image_url)
  SELECT title, description, price, image_url FROM temp_courses;
COMMIT;
